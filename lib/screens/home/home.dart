...
class HomeScreenState extends State<HomeScreen> {
  ...
  String _currentPlace = 'Current location';
  ...
  List<Map<String, dynamic>> shops = [
    ...
    },
    {
      ...
      'rate': 23,
      'location': [6.9271, 79.8612], // Replace with actual coordinates
      'score': 0.19
    },
    {
      'name': 'Hotel Janaki ***',
  ...
  setState(() {
    _currentPlace = "${place.locality}, ${place.country}";
  });
}
  ...
  void _updateMarkers() {
    if (currentLocation != null) {
      // Create new markers for the updated radius
